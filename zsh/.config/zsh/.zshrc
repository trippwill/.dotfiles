...
# Add $XDG_DATA_HOME/zsh/completions/ to fpath
# These are completions generated by tools
fpath=("$XDG_DATA_HOME/zsh/completions" $fpath)
# Add $ZDOTDIR/functions to fpath
...
# Array of other env files to source
env_files=(
  "$HOME/.cargo/env"
  "$HOME/.deno/env"
#  "$ASDF_DATA_DIR/plugins/dotnet/set-dotnet-env.zsh"
)
